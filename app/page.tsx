    ...
    <div className="min-h-screen bg-white overflow-x-hidden scroll-smooth">
      ...
      <section className="relative flex justify-center bg-[linear-gradient(180deg,_#f0fdf4_0%,_#ffffff_50%,_#eff6ff_100%)] min-h-[80vh] md:min-h-[90vh] px-4">
        <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between py-12 md:py-20 gap-12 z-10">
          <motion.div
            ...
            animate="visible"
            variants={fadeInUp}
            className="flex flex-col gap-6 md:gap-8 max-w-2xl text-center lg:text-left items-center lg:items-start"
          >
          ...
          <motion.div
            ...
            className="bg-gray-200 rounded-[40px] w-full max-w-[300px] aspect-square md:max-w-[450px] shadow-2xl overflow-hidden border-[12px] border-white"
          >
            <Image
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          <motion.h2 variants={fadeInUp} className="text-3xl md:text-4xl font-bold text-gray-900 mb-16">
            Почему выбирают нас
          </motion.h2>

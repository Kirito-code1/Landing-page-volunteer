      ...
      <div className="max-w-4xl w-full text-center flex flex-col items-center gap-8">
        <div className="flex flex-col gap-4">
          <h2 className="text-3xl md:text-5xl font-bold text-white tracking-tight">
            {pick({
              ru: "Готовы начать делать добро?",
              en: "Ready to Start Doing Good?",
              uz: "Yaxshilik qilishga tayyormisiz?",
            })}
          </h2>
          <p className="text-white/90 text-lg md:text-xl font-medium">
            {pick({
              ru: "Присоединяйтесь к тысячам волонтёров по всей стране",
              en: "Join thousands of volunteers across the country",
              uz: "Mamlakat bo'ylab minglab volontyorlarga qo'shiling",
            })}
          </p>
        </div>
        ...
        <button className="bg-white text-gray-900 px-10 py-4 rounded-full font-bold text-lg flex items-center gap-3 hover:bg-gray-50 transition-colors shadow-lg shadow-black/5">
          {pick({ ru: "Зарегистрироваться", en: "Sign Up", uz: "Ro'yxatdan o'tish" })}
